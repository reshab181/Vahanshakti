...
import { getInfoLive, searchEMEIDevice } from "../../apis/deviceInventory";
...
export const DeviceActivationVahan = () => {
  ...
  const getDeviceInfo = async () => {
    const result_vahan_esim = await getInfoLive(String(id), String(IMEI));
  ...
  return (
    <>
      ...
      {data && !toggle && <InfoDataVahanComponent data = {data} getInfo= {getDeviceInfo} setLoading={setLoading}/>}
