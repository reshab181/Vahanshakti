...
import { deviceDetailLiveByID, getOTP, revalidateOTP, revalidateOTPLive} from "../../../apis/deviceInventory";
...
export const ReActivationComponentLive = (props) => {
  ...
  const handleValidateOTP = async (e) => {
    ...
    try {
      const response = await revalidateOTPLive(uploadData);
      if (response.status === true) {
        Swal.fire({
          icon: "success",
          title: "Success!",
