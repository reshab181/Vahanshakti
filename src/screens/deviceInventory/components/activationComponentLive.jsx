...
import { deviceDetailLiveByID, getOTP, getPermitHolder, validateVahanOTP } from "../../../apis/deviceInventory";
...
export const ActivationComponentLive = (props) => {
  ...
  const handleCheckPermit = async(e) => {
    ...
    try{
      ...
      console.log("resultMobileCheck",result);
  ...
  const handleValidateOTP = async (e) => {
    ...
    try {
      const response = await validateVahanOTP(uploadData);
      if (response.status === true) {
        Swal.fire({
          icon: "success",
          title: "Success!",
        ...
        <div style={{ marginBottom: "20px", marginTop: "20px" }}>
          <div style={{ width: "97%", border: '1px solid gainsboro', padding: '10px', backgroundColor: 'white', margin: "auto" }}>
            ...
            <div>
              ...
              <button className="form_button button_submit" style={{marginTop: '15px'}} onClick={handleGetOTP}>Send OTP</button>
            </div>}
